...
export const AUDIT_EVENTS = {
 ...
 WORKER_CREATED:'worker.created', WORKER_AUTHENTICATED:'worker.authenticated', WORKER_AUTHENTICATION_FAILED:'worker.authentication_failed', WORKER_SUSPENDED:'worker.suspended', WORKER_REVOKED:'worker.revoked',
