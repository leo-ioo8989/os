...
CREATE TABLE "Job" (
  "id" TEXT NOT NULL, "organizationId" TEXT NOT NULL, "objectiveId" TEXT, "taskId" TEXT, "workflowId" TEXT,
  "status" "JobStatus" NOT NULL DEFAULT 'QUEUED', "attemptNumber" INTEGER NOT NULL DEFAULT 0, "maxAttempts" INTEGER NOT NULL DEFAULT 3, "priority" INTEGER NOT NULL DEFAULT 0,
  "workerId" TEXT, "leaseExpiresAt" TIMESTAMP(3), "lastHeartbeatAt" TIMESTAMP(3), "startedAt" TIMESTAMP(3), "completedAt" TIMESTAMP(3),
  "failureCode" TEXT, "failureMessage" TEXT, "failureRetryable" BOOLEAN, "nextRetryAt" TIMESTAMP(3), "resumableState" JSONB NOT NULL, "metadata" JSONB NOT NULL,
...
CREATE TABLE "Checkpoint" (
  "id" TEXT NOT NULL, "organizationId" TEXT NOT NULL, "jobId" TEXT NOT NULL, "version" INTEGER NOT NULL, "state" JSONB NOT NULL, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
