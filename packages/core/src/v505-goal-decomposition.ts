...
export interface GoalProposedTask { id: string; parentObjectiveId: string; description: string; depth: number; }
export function decomposeGoal(g: Goal): GoalProposedTask[] {
