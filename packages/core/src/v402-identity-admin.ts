...
export interface RoleBinding { userId:string; organizationId:string; role:Role; scopes:string[]; }
export interface IdentityContext { userId:string; organizationId:string; roles:Role[]; scopes:string[]; sessionId:string; }
