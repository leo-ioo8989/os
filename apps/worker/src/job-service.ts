...
export class JobService {
  ...
  waitForApproval(organizationId:string,id:string,workerId:string){return this.repository.setApprovalBlocked(organizationId,id,workerId,{organizationId,actorType:'AGENT',eventType:AUDIT_EVENTS.WORKFLOW_APPROVAL_BLOCKED,action:'approval_required',result:'SUCCESS'});}
